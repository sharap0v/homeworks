...
class ToAdresItem(BaseItem):
    def __init__(self, heading, flat):
        super(ToAdresItem, self).__init__(heading)
        self.flat = flat
    ...
    def construct(cls):
        input_function = get_input_function()
        heading = input_function('Input heading: ')
        flat = input_function('Input adress: ')
        return ToAdresItem(heading, flat)